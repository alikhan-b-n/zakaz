        ...
        <div className="">
            <div className="3xl:w-[1262px] 3xl:h-[429px] 2xl:w-[1000px] xl:w-[800px] lg:w-[500px] sm:w-[350px] rounded-xl bg-white grid grid-cols-2 lg:grid-cols-1 lg:h-[520px] justify-items-center items-center drop-shadow-lg ">
                ...
                <div className="3xl:ml-[-100px] 2xl:ml-[-50px] xl:ml-0">
                    <div className="3xl:w-[323px] h-[43px] sm:w-[250px] shadow-custom bg-gray-100 rounded-[15px] flex items-center pl-2 mb-[15px]">{props.user.firstname}</div>
                    <div className="3xl:w-[323px] h-[43px] sm:w-[250px] shadow-custom bg-gray-100 rounded-[15px] flex items-center pl-2 mb-[15px]">{props.user.lastname}</div>
                    <div className="3xl:w-[323px] h-[43px] sm:w-[250px] shadow-custom bg-gray-100 rounded-[15px] flex items-center pl-2 mb-[15px]">{props.user.email}</div>
