...
export function DailyQuizComponent() {
    const {id} = useParams()
    ...
    const {mutate, isLoading, isError, error} = useMutation(async () =>
        await axios.post(`${baseUrl}/adminPanel/adminCreateDailyQuiz`, {
                ...
                <div
                    ...
                    <div className="bg-white px-6 py-8 rounded-2xl shadow-md text-black w-full">
                        <div className="flex justify-between">
                            ...
                            <h1 className="flex-1 mb-5 text-2xl text-center ml-3">Создание Daily QUIZ</h1>
                        </div>
                    ...
                    justify-self-center text-white ">Добавить тест
                            </button>
                        </div>
                    </div>
                </div>
